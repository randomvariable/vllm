...
class TestMarkerCacheGate:
    """Answer-phase temperature tracking lives in SamplingStates, not
    ThinkingBudgetState.tracked_np (which gates _requires_logits_processing).
    """
