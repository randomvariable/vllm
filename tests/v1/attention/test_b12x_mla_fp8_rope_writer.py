...
def _install_fake_writer_package(
    ...
    b12x_module: Any = types.ModuleType("b12x")
    b12x_module.__path__ = []
    attention_module: Any = types.ModuleType("b12x.attention")
    attention_module.__path__ = []
    shared_module: Any = types.ModuleType("b12x.attention._shared")
    shared_module.__path__ = []
    mla_module: Any = types.ModuleType("b12x.attention._shared.mla")
    mla_module.__path__ = []
