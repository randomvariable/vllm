...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Experimental opt-in for adaptive shm_broadcast reader and writer waits.
    # The default retains the fixed one-second reader grace and writer yields.
    "VLLM_EXPERIMENTAL_SHM_BROADCAST_ADAPTIVE_SPIN": lambda: bool(
        int(os.getenv("VLLM_EXPERIMENTAL_SHM_BROADCAST_ADAPTIVE_SPIN", "0"))
    ),
    # Tunables for the experimental adaptive shm_broadcast reader spin grace. Readers
    ...
    # HC prefill row ownership: off, control, or shard. Opt-in pending serving
    # qualification; ranks must agree at startup.
