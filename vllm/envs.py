...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Opt-in gate for the Cohere Chat v2 endpoint (`POST /cohere/v2/chat`).
    # The route is only attached when this is 1 and the optional `cohere` SDK
    # is installed; otherwise the server boots without it.
