...
class DeepseekV4SWACache(torch.nn.Module, AttentionLayerBase):
    ...
    def get_kv_cache_spec(self, vllm_config: VllmConfig) -> KVCacheSpec:
        ...
        uses_nvfp4_ds_mla_layout = self.cache_config.cache_dtype == "nvfp4_ds_mla"
        return SlidingWindowMLASpec(
            ...
            # 8B scales); nvfp4_ds_mla: 432B (256B E2M1 NoPE + 32B E4M3 scales
            # + 16B pad + 128B BF16 RoPE). The SWA cache stores the same record
            # as the full MLA cache.
            state_content_bytes=(
                584
