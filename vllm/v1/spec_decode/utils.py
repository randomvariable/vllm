...
class EagleStepSlotMappingMetadataKernel(
    ...
    def __call__(
        ...
        cast(Any, self.kernel)[(input_batch_size,)](
            positions_1d,
            block_table_tensor,
...
def get_eagle_step_slot_mapping_kernel() -> EagleStepSlotMappingMetadataKernel:
    return _EAGLE_STEP_SLOT_MAPPING_KERNEL
...
def get_eagle_prepare_inputs_kernel() -> EaglePrepareInputsPaddedKernel:
    return _EAGLE_PREPARE_INPUTS_KERNEL
...
def get_eagle_prepare_next_token_kernel() -> EaglePrepareNextTokenPaddedKernel:
    return _EAGLE_PREPARE_NEXT_TOKEN_KERNEL
