...
def compute_fp8_einsum_recipe() -> tuple[tuple[int, int, int], bool]:
    ...
    SM12x: our pinned DeepGEMM has no SM120 fp8_bmm path, so SM12x dispatches
    to sm90_fp8_bmm and needs the SM90 raw row-major FP32 layout; the SM100
    packed/TMA-aligned scales produce NaNs there.
